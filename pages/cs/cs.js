...
Page({
  ...
  yjian(e){
    ...
    wx.request({
      url: 'http://192.168.8.180:8000/publish/publishassignment',
      method:"get",
      data:{
        id
      },
  ...
  radioChange(e){
    ...
    _selectImage(e){
      ...
      // wx.request({
      //   url: 'http://192.168.8.180:8000/publish/tupian',
  ...
  //   if (Uploader.isSupport()) {
    wx.chooseMedia({
      ...
      success(res) {
        ...
        wx.uploadFile({
          url: 'http://192.168.8.180:8000/publish/upload_video', //仅为示例，非真实的接口地址
          filePath: tempFilePaths,
          name: 'vido',
          success:res=>{
            console.log(res.data);
